      ...
      <form action="" id="report-form" method="post" novalidate>
        ...
        <div class="row g-4">
          <div class="col-md-6">
            ...
            <!-- lab no -->
            <div class="form-floating mt-3">
            <input type="text" name="labNo" id="labNo" class="form-control" placeholder="Lab No" required>
            <label for="labNo">Lab No</label>
            </div>

            <div class="form-floating mt-3">
              <input type="text" name="footer_text" id="age" class="form-control" placeholder="Report Of Examination" required>
          ...
          <!-- <div class="form-floating col-md-6">
                ...
                <input type="text" name="footer_text" placeholder="Report Of Examination" required>
          </div> -->
    ...
    <script>
        ...
        const reportTests = {
            ...
            "LipidProfile 3": [
                ...
                {
                    "code": "F4",
                    "test": "URIC ACID (SERUM)",
                    "result": "",
                    "normal": "(2.5-6.8) Mg/dl.",
                    "mainexamination": "LipidProfile 3"
                },
                {
                    "code": "F5",
                    "test": "CALCIUM (SERUM)",
                    "result": "",
                    "normal": "(8.4-10.4) Mg/dl.",
                    "mainexamination": "LipidProfile 3"
                },
                {
                    "code": "F6",
                    "test": "Alkaline Phosphate (SERUM)",
                    "result": "",
                    "normal": "(108-306)IU/L",
                    "mainexamination": "LipidProfile 3"
                },
                ...
                {
                    "code": "F10",
                    "test": "AS O TITRE (SERUM)",
                    "result": "",
                    "normal": "(Bellow 200 ) lu/ml.",
                    "mainexamination": "LipidProfile 3"
                },
                {
                    "code": "F10",
                    "test": "RA FACTOR(SERUM)",
                    "result": "",
                    "normal": "(Up to 20)lu/ml",
                    "mainexamination": "LipidProfile 3"
                },
                {
                    "code": "F10",
            ...
            "Widal": [
                ...
                {
                    "code": "n5",
                    "test": "* * A diagnostic titre of",
                    "result": "1:160& 1:80  Suggested Positive reaction.",
                    "normal": "",
                    "examination": "WIDAL TEST",
                    "mainexamination": "WidalAndInfectionPanel"
                },
            ...
            "Widal_Malaria And Dengue": [
                ...
                {
                    "code": "n5",
                    "test": " ** ** A Diagnostic Titer of 1:160 & 1:80  Suggested Positive reaction.",
                    "result": "",
                    "normal": "160 & 180",
                    "examination": "WIDAL TEST",
                    "mainexamination": "WidalAndInfectionPanel"
