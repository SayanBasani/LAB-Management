...
<head>
  <meta charset="UTF-8">
  <title><?php echo $config['clinic_name'] ?>- Invoice System</title>
        ...
        foreach($invoiceList as $invoiceDetails){
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="print_invoice.php?invoice_id='.$invoiceDetails["order_id"].'" class="btn btn-sm btn-outline-primary" title="Print">
