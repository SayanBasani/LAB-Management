...
<head>
  <meta charset="UTF-8">
  <title>Create Invoice - <?php echo $config['clinic_name'] ?></title>
  ...
  <style>
    ...
    .navbar { background-color: #fff !important; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
    .navbar-brand, .navbar-nav .nav-link { color: #000 !important; font-weight: 500; }
    .container { margin-top: 80px; }
    .form-title { font-size: 28px; font-weight: 600; color: #4a148c; margin-bottom: 25px; border-bottom: 2px solid #d1c4e9; padding-bottom: 10px; }
    .invoice-card { background-color: #fff; padding: 2rem; border-radius: 16px; box-shadow: 0 6px 24px rgba(0,0,0,0.1); }
    .form-label { font-weight: 500; }
    .table th { background-color: #ede7f6; color: #4a148c; font-weight: 600; }
    .btn-main { background-color: #7e57c2; color: white; font-weight: 500; border-radius: 30px; padding: 10px 30px; }
    .btn-main:hover { background-color: #512da8; }
    .btn-outline-danger, .btn-outline-success { border-radius: 30px; padding: 8px 20px; }
  </style>
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><?php echo $config['clinic_name'] ?> Invoice System</a>
...
<script>
  $(document).ready(function() {
    calculateTotal(); // trigger subtotal calc
  });
</script>
</body>
</html>
